...
export function Header({ login, wallet, walletConnected,setWalletConnected}: any) {
  ...
  return (
    <div className="Header">
        <div className="AppName">
            <div><img className= "ImageLogo"src={logo}/></div>
       ...
       <div className="connectToWalletModule">
            ...
            <button className="buttonColor" onClick={login}> {!connected === false  ?  "Connected" : "Click to Connect"}</button>
        </div>
